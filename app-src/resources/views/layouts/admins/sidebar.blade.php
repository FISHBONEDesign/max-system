<div class="sidebar-wrapper bg-light border-right">
    ...
    <div class="list-group list-group-flush">
        ...
        <a href="{{ route('admin.manage.firmwares') }}" class="list-group-item list-group-item-action @if (request()->routeIs('admin.manage.firmwares.*')) active @else bg-light @endif">Manage Firmwares</a>
    </div>
</div>
